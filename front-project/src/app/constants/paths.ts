...
export const COUNSELING = "counseling/:id";
export const COUNSELINGS = "counselings";
export const DETAIL_COUNSELING = "detail-counseling/:id";
export const DETAIL_TEACHER = "detail-teacher/:id";
...
export const TEACHER_WEEK_SCHEDULE = "teacher/week-schedule";
